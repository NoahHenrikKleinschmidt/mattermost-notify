...
def test_can_send_text_file_to_channel():
    ...
    client = Notify(**config)
    response = client.send_to_channel("Hello, World!", channel_name=test_channel_name, files=["tests/test_client.py"])
    assert response
...
def test_can_send_text_file_to_user():
    ...
    client = Notify(**config)
    response = client.send_to_user("Hello, World!", user_name=test_user_name, files=["tests/test_client.py"])
    assert response
...
def test_can_send_image_file_to_channel():
    ...
    client = Notify(**config)
    response = client.send_to_channel("The Notify Bot can upload even files now!", channel_name=test_channel_name, files=["tests/test_kitty.jpg"])
    assert response
...
def test_can_send_image_file_to_user():
    ...
    client = Notify(**config)
    response = client.send_to_user("The Notify Bot can upload even files now!", user_name=test_user_name, files=["tests/test_kitty.jpg"])
    assert response